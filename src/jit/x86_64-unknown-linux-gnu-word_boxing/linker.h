...
*((uint32_t *)(text + 375)) = (uint32_t)(((uintptr_t)_str_const_op_send_dbg2) + (0));
  *((int32_t *)(text + 385)) = (int32_t)(((uintptr_t)printf) + (-4) - ((uintptr_t)(text + 385)));
  *((int32_t *)(text + 405)) = (int32_t)(((uintptr_t)mrb_jit_enter) + (-4) - ((uintptr_t)(text + 405)));
}
