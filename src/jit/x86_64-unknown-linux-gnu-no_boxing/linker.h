...
*((uint32_t *)(text + 395)) += (uint32_t)(((uintptr_t)_str_const_op_send_dbg2) + (0));
*((uint32_t *)(text + 401)) += (uint32_t)(((uintptr_t)pc) + (0));
  *((int32_t *)(text + 411)) += (int32_t)(((uintptr_t)printf) + (-4) - ((uintptr_t)(text + 411)));
  *((int32_t *)(text + 431)) += (int32_t)(((uintptr_t)mrb_jit_enter) + (-4) - ((uintptr_t)(text + 431)));
}
